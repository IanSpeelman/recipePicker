const recipes = [
	...
	},
	{
		...
		description:
			"A popular Indian curry dish made with marinated chicken cooked in a spiced tomato sauce.",
		cuisine: "Indian",
		servings: 4,
		prep_time: 30,
		cook_time: 40,
	...
	},
	{
		name: "Beef Tacos",
		description:
			"A Mexican staple, these tacos are filled with seasoned beef, fresh vegetables, and a variety of toppings.",
		cuisine: "Mexican",
		servings: 4,
		prep_time: 20,
		cook_time: 15,
	...
	},
	{
		name: "Caprese Salad",
		description:
			"A simple Italian salad made with tomatoes, mozzarella, and fresh basil, drizzled with olive oil and balsamic glaze.",
		cuisine: "Italian",
		servings: 4,
		prep_time: 10,
		cook_time: 0,
	...
	},
	{
		...
		description:
			"A quick and easy stir fry with a variety of fresh vegetables and a savory sauce.",
		cuisine: "Asian",
		servings: 4,
		prep_time: 15,
		cook_time: 10,
	...
	},
	{
		...
		description:
			"Classic chocolate chip cookies with a chewy center and crispy edges.",
		cuisine: "American",
		servings: 24,
		prep_time: 15,
		cook_time: 12,
	...
	},
	{
		name: "Caesar Salad",
		description:
			"A classic salad with romaine lettuce, Parmesan cheese, croutons, and a creamy Caesar dressing.",
		cuisine: "American",
		servings: 4,
		prep_time: 15,
		cook_time: 0,
	...
	},
	{
		name: "Guacamole",
		description:
			"A creamy avocado dip mixed with lime, cilantro, tomatoes, and onions.",
		cuisine: "Mexican",
		servings: 4,
		prep_time: 10,
		cook_time: 0,
	...
	},
	{
		name: "Banana Bread",
		description:
			"A moist and delicious banana bread made with ripe bananas, walnuts, and a hint of cinnamon.",
		cuisine: "American",
		servings: 8,
		prep_time: 15,
		cook_time: 60,
	...
	},
	{
		name: "Greek Salad",
		description:
			"A refreshing salad with tomatoes, cucumbers, olives, and feta cheese, dressed with olive oil and oregano.",
		cuisine: "Greek",
		servings: 4,
		prep_time: 15,
		cook_time: 0,
	...
	},
	{
		name: "Pancakes",
		description:
			"Fluffy pancakes perfect for a weekend breakfast, served with syrup and fresh fruit.",
		cuisine: "American",
		servings: 4,
		prep_time: 10,
		cook_time: 20,
	...
	},
	{
		name: "Tom Yum Soup",
		description:
			"A spicy and sour Thai soup with shrimp, mushrooms, and fresh herbs.",
		cuisine: "Thai",
		servings: 4,
		prep_time: 15,
		cook_time: 20,
	...
	},
	{
		name: "Egg Fried Rice",
		description:
			"A quick and easy fried rice with eggs, vegetables, and soy sauce.",
		cuisine: "Chinese",
		servings: 4,
		prep_time: 10,
		cook_time: 15,
	...
	},
	{
		name: "Clam Chowder",
		description:
			"A creamy New England clam chowder with potatoes, clams, and bacon.",
		cuisine: "American",
		servings: 6,
		prep_time: 20,
		cook_time: 30,
	...
	},
	{
		name: "Pesto Pasta",
		description:
			"Pasta tossed in a fresh basil pesto sauce with Parmesan cheese and pine nuts.",
		cuisine: "Italian",
		servings: 4,
		prep_time: 10,
		cook_time: 15,
	...
	},
	{
		...
		description:
			"A comforting chicken noodle soup with tender chicken, vegetables, and egg noodles.",
		cuisine: "American",
		servings: 6,
		prep_time: 20,
		cook_time: 30,
...
mongoose
	.connect("mongodb://localhost:27017/recipe-picker")
...
seedRecipes().then(() => mongoose.disconnect());
